...
public:
    ...
    void setupUi(QWidget *WelcomeView)
    {
        ...
        btDepartment->setMaximumSize(QSize(70, 70));
        btDepartment->setBaseSize(QSize(0, 2));
        ...
        btDoctor->setMaximumSize(QSize(70, 70));
        ...
        btPatient->setMaximumSize(QSize(70, 70));
